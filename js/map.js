(function($) {
    ...
    var myLatlng = new google.maps.LatLng(19.5219202, -99.21574049999998); // Change map location here
    ...
    function initialize() {
        ...
        var contentString = '<div id="content-map">' +
            '<div id="siteNotice">' +
            '</div>' +
            '<h5 id="firstHeading" class="firstHeading">Starkend</h5>' +
